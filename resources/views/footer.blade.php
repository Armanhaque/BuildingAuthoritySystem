            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="contact-item">
                        ...
                        <div class="contact-item-info">01750342433</div>
                    </div><!-- .contact-item -->
                </div><!-- .col-# -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="contact-item">
                        ...
                        <div class="contact-item-info">arman35-2080@diu.edu.bd</div>
                    </div><!-- .contact-item -->
                </div><!-- .col-# -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="contact-item">
                        ...
                        <div class="contact-item-info">Dhaka,shyamoli,1215</div>
                    </div><!-- .contact-item -->
                </div><!-- .col-# -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="contact-item">
                        ...
                        <div class="contact-item-info">Sat - Thurs: 9.00 - 17:00</div>
                    </div><!-- .contact-item -->
                </div><!-- .col-# -->
            </div><!-- .row -->
        </div><!-- container -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <section class="widget">
                        ...
                        <ul>
                            <li><a href="#">Full Security</a></li>
                            <li><a href="#">Online based service</a></li>
                            <li><a href="#">Easy process for permission</a></li>
                        </ul>
                    </section><!-- .widget -->
                </div><!-- .col-## -->
                ...
                <div class="col-md-3 col-sm-6">
                    <section class="widget">
                        ...
                        <p>Dhaka,shyamoli,1215.</p>
                        <p>arman35-2080@diu.edu.bd<br>01750342433</p>
                    </section>
                </div><!-- .col-## -->
            </div><!-- .row -->
        </div><!-- .container -->
